import librosa  # 0.8.0
import numpy as np
import pywt  #install pywavelets
import os
...
n_imfcc = 13
n_mfcc = 13
n_cqt = 13 # should be 36
f_max = sample_rate / 2
f_min = f_max / 2**9

directory_path = "C:\\ASVspoof_Data\\LA\\ASVspoof2019_LA_train\\flac\\"
...
def extract_mfcc(wav_path):
    ...
    mfcc_delta_delta = librosa.feature.delta(mfcc, mode='nearest')
...
def walk_files(file_path):
    for file_name in os.listdir(file_path):
        print(file_path + file_name)
        #print(extract(file_path + file_name, "spect"))
        #print(extract(file_path + file_name, "mfcc"))
        print(extract(file_path + file_name, "cqt"))

if __name__ == '__main__':
    walk_files(directory_path)
